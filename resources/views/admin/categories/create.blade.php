                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" type="text" value="{{ old('name') }}" class="form-control" id="" placeholder="Nhập tên danh mục khóa học">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control">
                                <option value="{{ \App\Models\Category::INACTIVE }}" {{ old('status') == \App\Models\Category::INACTIVE ? 'selected' : '' }}>
                                    Đang đóng</option>
                                <option value="{{ \App\Models\Category::ACTIVE }}" {{ old('status') == \App\Models\Category::ACTIVE ? 'selected' : '' }}>
                                    Đang mở</option>
                            </select>
                            <small id="" class="form-text text-muted"></small>
                            @error('status')
