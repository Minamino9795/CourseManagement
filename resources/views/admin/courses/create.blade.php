                ...
                <form method="post" action="{{ route('courses.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="tf1">Giá <abbr name="Trường bắt buộc">*</abbr></label>
                            ...
                            <div class="form-group">
                                <label for="tf1">Danh mục<abbr name="Trường bắt buộc">*</abbr></label>
                            ...
                            <div class="form-group">
                                <label for="tf1">Cấp độ<abbr name="Trường bắt buộc">*</abbr></label>
                            ...
                            <div class="form-group">
                                ...
                                <input name="image_url" type="file" value="" class="form-control" id="">
                                <small id="" class="form-text text-muted"></small>
                                @error('image_url')
                                    <div style="color: red">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input name="video_url" type="file" value="" class="form-control" id="">
                                <small id="" class="form-text text-muted"></small>
                                @error('video_url')
                                    <div style="color: red">{{ $message }}</div>
                                @enderror
