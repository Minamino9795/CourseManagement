        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active">
                    <a href="{{ route('levels.index') }}"><i class="breadcrumb-icon fa fa-angle-left mr-2"></i>Trang Chủ</a>
                </li>
            </ol>
        </nav>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input name="name" type="text" class="form-control" id="name" placeholder="Nhập tên cấp độ" value="{{ old('name') }}">
                ...
                <div class="form-group">
                    ...
                    <input name="level" type="text" class="form-control" id="level" placeholder="Nhập cấp độ" value="{{ old('level') }}">
