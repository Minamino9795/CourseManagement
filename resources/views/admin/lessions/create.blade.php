                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <textarea name="content" class="form-control" placeholder="Nhập nội dung">{{ old('content') }}</textarea>
                                    <small class="form-text text-muted"></small>
                                    @error('content')
                                        <div style="color: red">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="file" class="form-control" name="video_url" placeholder="Video..."
