                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <select name="type" class="form-control" id="type">
                                                ...
                                                <option value="Bài đọc"
                                                    {{ request('type') === 'Bài đọc' ? 'selected' : '' }}>Bài đọc</option>
                                                <option value="Thực hành"
                                                    {{ request('type') === 'Thực hành' ? 'selected' : '' }}>Thực hành
                                                </option>
                                                <option value="Xem video"
                                                    {{ request('type') === 'Xem video' ? 'selected' : '' }}>Xem video
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if (Auth::user()->hasPermission('lessions_update'))
                                                        <a href="{{ route('lession.show', ['id' => $item->id]) }}"
