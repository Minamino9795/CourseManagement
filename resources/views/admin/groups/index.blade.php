        ...
        <div class="page-section">
            <div class="card card-fluid">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col">
                            <form action="https://thptatuc-backend.quanlythietbitruonghoc.com/groups" method="GET" id="form-search">
                                <div class="row">
                                    <div class="col">
                                        <input name="search" value="" class="form-control" type="text" placeholder=" tên...">
                                    </div>
                                    <div class="col-lg-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if (Auth::user()->hasPermission('groups_update'))
                                    <span class="sr-only">Edit</span> <a href="{{route('groups.edit',$group->id)}}" class="btn btn-sm btn-icon btn-secondary"><i class="fa fa-pencil-alt"></i>
                                    ...
                                    <form action="{{ route('groups.destroy',$group->id )}}" method="POST" class="d-inline">
                                        ...
                                        <input type="hidden" name="_token" value="CNND3NJoI2a9s3VW6nf8WdMH48c3KoYnodRDcvL3"> <input type="hidden" name="_method" value="DELETE"> <button type="submit" onclick="return confirm('Bạn có muốn xóa không ?')" class="btn btn-sm btn-icon btn-secondary"><i class="far fa-trash-alt"></i></button>
                                        @endif
                                        @if (Auth::user()->hasPermission('groups_view'))
                                        <a class="btn btn-sm btn-icon btn-secondary" href="{{ route('groups.show', $group->id) }}">
